/* eslint-disable */
!(function (e) { if (typeof exports === 'object' && typeof module !== 'undefined')module.exports = e(); else if (typeof define === 'function' && define.amd)define([], e); else { let f; typeof window !== 'undefined' ? f = window : typeof global !== 'undefined' ? f = global : typeof self !== 'undefined' && (f = self), f.hull = e(); } }(() => {
  let define,
    module,
  ...
  2: [function (require, module, exports) {
    module.exports = {
      ...
      fromXy(pointset, format) {
        ...
        return pointset.map((pt) => {
          /* jslint evil: true */
          const _getObj = new Function('pt', `var o = {}; o${format[0]}= pt[0]; o${format[1]}= pt[1]; return o;`);
          return _getObj(pt);
        });
      }
  ...
  3: [function (require, module, exports) {
    function Grid(points, cellSize) {
      ...
      points.forEach(function (point) {
        let cellXY = this.point2CellXY(point),
          x = cellXY[0],
          y = cellXY[1];
    ...
    Grid.prototype = {
      ...
      rangePoints(bbox) { // (Array) -> Array
        let tlCellXY = this.point2CellXY([bbox[0], bbox[1]]),
...
*/
    ...
    function hull(pointset, concavity, format) {
      ...
      innerPoints = points.filter(pt => convex.indexOf(pt) < 0);
