...
var SideViewManager = function () {
    function SideViewManager() {
        _classCallCheck(this, SideViewManager);
    ...
    _createClass(SideViewManager, [{
        key: "makeView",
        value: function makeView(group, representativeThesisId, groupColor) {
    ...
    return SideViewManager;
}();

var sideViewManager = new SideViewManager();
